...
public final class VoiceTag extends DomainBaseEntity {
    ...
    /**
     * A clip the user recorded elsewhere and uploaded. It carries no synthesis metadata — there is no
     * source text, language or voice, because nothing was synthesised.
     */
