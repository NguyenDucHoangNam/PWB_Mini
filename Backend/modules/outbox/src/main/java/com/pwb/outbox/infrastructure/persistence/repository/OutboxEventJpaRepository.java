package com.pwb.outbox.infrastructure.persistence.repository;
...
public interface OutboxEventJpaRepository extends JpaRepository<OutboxEventJpaEntity, UUID> {
    ...
    List<OutboxEventJpaEntity> findByStatusAndRetryCountLessThan(OutboxStatus status, int maxRetries);
}
