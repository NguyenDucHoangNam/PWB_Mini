package com.pwb.backend.modules.iam.internal.controller;
...
import com.pwb.backend.modules.iam.internal.service.AuthService;
...
@AutoConfigureMockMvc(addFilters = false) // Tắt bộ lọc Security để test validation & routing của Controller
