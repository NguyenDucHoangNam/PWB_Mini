...
import com.pwb.backend.audio.internal.helper.FfmpegExecutor;
import com.pwb.backend.audio.internal.helper.FfmpegProbeResult;
import com.pwb.backend.audio.internal.helper.S3KeyBuilder;
import com.pwb.backend.audio.internal.helper.WaveformExtractor;
...
public class AudioProcessingWorker {
  ...
  private void process(AudioProcessingEvent event) {
    ...
    try {
      ...
      com.pwb.backend.audio.internal.helper.FfmpegValidator.validate(probe);
