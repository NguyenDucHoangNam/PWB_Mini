...
public class WaveformExtractor {
  ...
  private final com.pwb.backend.audio.internal.helper.FfmpegExecutor ffmpegExecutor;
  private final com.pwb.backend.audio.internal.config.AudioProperties audioProperties;
