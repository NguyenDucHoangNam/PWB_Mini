...
import com.pwb.backend.audio.internal.application.helper.MimeToExtensionMapper;
import com.pwb.backend.audio.internal.application.helper.S3KeyBuilder;
import com.pwb.backend.audio.internal.application.helper.UploadClaim;
import com.pwb.backend.audio.internal.application.helper.UploadClaimService;
...
public class DemoUploadService {
  ...
  public ConfirmUploadResponse confirmUpload(String userId, String ownerDisplayName, ConfirmUploadRequest req) {
    ...
    demo.setOwnerDisplayName(ownerDisplayName);
