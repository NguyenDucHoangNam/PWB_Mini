...
import com.pwb.backend.audio.api.dto.response.SharedDemoResponse;
import com.pwb.backend.audio.api.dto.request.VerifyOtpRequest;
import com.pwb.backend.audio.api.dto.response.WsTokenResponse;
...
import com.pwb.backend.audio.internal.application.helper.ClientIpSubnetMasker;
...
import com.pwb.backend.audio.internal.application.service.AesKeyCacheService;
import com.pwb.backend.audio.internal.application.service.BruteForceGuardService;
import com.pwb.backend.audio.internal.application.service.DistributionCacheService;
import com.pwb.backend.audio.internal.application.service.OtpService;
import com.pwb.backend.audio.internal.application.service.SharedTokenGuardService;
import com.pwb.backend.audio.internal.application.service.StreamSecureCookieService;
...
public class SharedDemoController {
  ...
  public ResponseEntity<ApiResponse<SharedDemoResponse>> getSharedDemo(
    ...
    SharedDemoResponse data = new SharedDemoResponse(
        ...
        demo.getOwnerDisplayName() != null ? demo.getOwnerDisplayName() : "",
