...
public enum IamErrorCode implements ErrorCode {
    ...
    REGISTRATION_IN_PROGRESS("REGISTRATION_IN_PROGRESS", "Account is pending OTP verification", HttpStatus.BAD_REQUEST),
    ...
    OAUTH_EMAIL_CONFLICT("OAUTH_EMAIL_CONFLICT", "Email already registered with a different sign-in method", HttpStatus.CONFLICT),
