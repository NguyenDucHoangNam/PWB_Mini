...
export const ERROR_CODE_TO_I18N_KEY: Record<string, string> = {
  VOICE_001: "voice.errors.titleRequired",
  VOICE_002: "voice.errors.intervalInvalid",
  VOICE_003: "voice.errors.volumeRange",
  VOICE_004: "voice.errors.fileTooLarge",
  VOICE_005: "voice.errors.unsupportedFormat",
  VOICE_006: "voice.errors.processingFailed",
  VOICE_007: "voice.errors.songNotFound",
  VOICE_008: "voice.errors.alreadyProcessed",
  VOICE_009: "voice.errors.streamNotReady",
  VOICE_010: "voice.errors.proOnly",
  VOICE_011: "voice.errors.voiceTagNotFound",
...
export function resolveErrorI18nKey(
